...
with st.sidebar:
    ...
    candidate_type = st.selectbox(
        "Candidate Type (for evaluation tagging)",
        ["strong", "average", "weak"]
    )
        ...
        try:
            ...
            with st.spinner("Analyzing Resume (Extracting Skills, Experience, Tools)..."):
                ...
                extraction_result = extraction_chain.invoke(
                    ...
                    config={
                        "run_name": f"{candidate_type.capitalize()} - Extraction",
                        "tags": [candidate_type, "extraction"]
                    }
                )
            ...
            with st.spinner("Evaluating applicant fit..."):
                ...
                eval_result = scoring_chain.invoke(
                    ...
                    config={
                        "run_name": f"{candidate_type.capitalize()} - Scoring",
                        "tags": [candidate_type, "evaluation"]
                    }
                )
